          ...
          <div className='Detail-div'>
            ...
            <div className='Detail-main-img'>
                 ...
                 <h2 className='Description-titel'>Description</h2>
                  <p className='Description-para'>A cappuccino is an approximately 150 ml (5 oz) beverage, with 25 ml of espresso coffee and 85ml of fresh milk the fo..  <span className='bold-active'>Read More</span> </p>
